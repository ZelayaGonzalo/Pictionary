...
export const data: Card[] = [
  ...
  new Card('Río de la Plata',
    'Lija',
    'Abrazar',
     'Dedo anular',
    'Pirata'
    ),
  new Card( 'Dentadura postiza',
    'Cubo',
     'Torpedear',
    'Fragancia',
    'Pelotón'
